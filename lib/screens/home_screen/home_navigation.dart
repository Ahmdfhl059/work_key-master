...
abstract final class HomeNavigation {
  ...
  static void openTarget(BuildContext context, String type, {String? id, String? value}) {
...
class HomeTargetPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(title: DefaultText(text: title, style: const TextStyle(color: HomeColors.ink, fontWeight: FontWeight.w700))),
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                DefaultText(text: title, style: const TextStyle(color: HomeColors.ink, fontSize: 22, fontWeight: FontWeight.w800)),
                const SizedBox(height: 8),
                const DefaultText(text: 'Your details are ready.', style: TextStyle(color: HomeColors.muted, fontSize: 14)),
              ],
            ),
          ),
        ),
